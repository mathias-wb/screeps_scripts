// This was the initial program I created to start off in screeps, I then 
// pivoted to a miner / gatherer setup as opposed to harvesters also mining energy.
...
const BODY = {
    ...
    harvester: [CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE], // High carry capacity
